<nav class="bg-gray-800" x-data="{ isOpen: false }">
    ...
    <div x-show="isOpen" class="md:hidden" id="mobile-menu">
        ...
        <div class="flex items-center px-5">
            ...
            <div class="ml-3">
            <div class="text-base font-medium leading-none text-white">Naufal Zul Faza</div>
            <div class="text-sm font-medium leading-none text-gray-400">naufalzul45@gmail.com</div>
            </div>
        </div>
